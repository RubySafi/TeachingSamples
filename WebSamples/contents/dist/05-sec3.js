const canvas = document.getElementById('sec3_slideCanvas');
...
let shapeSize;
let shapeInfo;
const infoElement = document.getElementById('sec3_slideGoalInfo');
const btnReset = document.getElementById('sec3_reset');
const btnQuiz = document.getElementById('sec3_quiz');
const btnLeft = document.getElementById('sec3_mode_L');
const btnUp = document.getElementById('sec3_mode_U');
const btnRight = document.getElementById('sec3_mode_R');
const btnDown = document.getElementById('sec3_mode_D');
createNew();
...
function updateInfoText() {
    ...
    let labelHeader = 'Move the <strong><span style="color: #3498db;">blue</span></strong> Block: ';
    let labelFooter = ' from the <strong><span style="color: #dbd034;">yellow</span></strong> Block.';
    let labelFlag = goalPos.x == currentPos.x && goalPos.y == currentPos.y
