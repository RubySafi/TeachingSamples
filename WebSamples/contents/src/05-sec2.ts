...
const infoElement = document.getElementById('slideInfo') as HTMLElement;

const btnReset = document.getElementById('sec2_reset') as HTMLButtonElement;
const btnNew = document.getElementById('sec2_new') as HTMLButtonElement;
const btnLeft = document.getElementById('sec2_mode_L') as HTMLButtonElement;
const btnUp = document.getElementById('sec2_mode_U') as HTMLButtonElement;
const btnRight = document.getElementById('sec2_mode_R') as HTMLButtonElement;
const btnDown = document.getElementById('sec2_mode_D') as HTMLButtonElement;
